...
import time
# from SS_2178_aruco_library import *
from aruco_library import *


image_list = [r"src/strawberry_stacker/task_1/scripts/test_image1.png",r"src/strawberry_stacker/task_1/scripts/test_image2.png"]
test_num = 1
...
for image in image_list:
	...
	if img is not None : 
		...
		result_image = r"Result_image"+str(test_num)+".png"
